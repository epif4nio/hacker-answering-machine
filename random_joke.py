...
# List of random jokes obtained from https://www.countryliving.com/life/entertainment/a36178514/hilariously-funny-jokes/

RANDOM_JOKES = ["Avocados are a fruit, not a vegetable. They're technically considered a single-seeded berry, believe it or not.",
...
"How do you open a banana? With a mon-key.   I wanted to buy some camo pants but couldn't find any.",
...
def get():
    return RANDOM_JOKES[random.randrange(len(RANDOM_JOKES))]
